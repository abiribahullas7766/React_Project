    ...
    <div className="text-white lg:px-24 px-4">
      ...
      <div>
        <h2 className="text-4xl font-bold text-center leading-snug lg:w-4/6 mx-auto pb-20">
          Our agile process is ability to adopt and respond to change. Agile
          organization view change as an opportunity, not a threat.{" "}
        </h2>

        {/* video player */}
        <a href="/">
          <div
            className="bg-[url('/src/assets/video_bg.jpeg')] bg-cover bg-no-repeat cursor-pointer 
                cs-video_block cs-style1 cs-video_open cs-bg"
          >
          ...
          <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-12">
            ...
            <div className="lg:w-1/3 space-y-5 z-30">
              ...
              <a href="" className="inline-flex items-center gap-2 font-semibold hover:text-orange
                transition-all duration-300 ease-in"><span> View More Blogs </span> <BsArrowRight />
              </a>
            </div>
            {/* cards */}
            <div className="lg:w-2/3 my-8">
                ...
                <div className="w-full mx-auto relative">
                    <button className="lg:absolute right-0 mt-8 px-6 py-2 bg-white text-black rounded
                    hover:bg-orange hover:text-white transition-all duration-300 hover:-translate-y-3">Read more</button>
                </div>
